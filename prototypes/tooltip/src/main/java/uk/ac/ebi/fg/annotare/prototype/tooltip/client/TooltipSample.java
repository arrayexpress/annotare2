...
//    CustomDataGrid<DataRow> dataGrid;
    ...
    interface TooltipSampleBinder extends UiBinder<Widget, TooltipSample> { //
    }
...
//        dataGrid = new CustomDataGrid<DataRow>(CustomDataGrid.createResources());
    ...
    public void onModuleLoad() {
        final TooltipSampleBinder binder = GWT.create(TooltipSampleBinder.class);
        final Widget widget = binder.createAndBindUi(this);
        RootLayoutPanel.get().add(widget);

        final TooltipPopup tooltip = new TooltipPopup();
        suggestBox.addFocusListener(new FocusListener() {
            @Override
            public void onFocus(Widget sender) {
                tooltip.showTip(suggestBox.getElement());
            }
