 ...
 *
 * <p>
 * <h3>Columns</h3> The {@link Column} class defines the {@link com.google.gwt.cell.client.Cell} used to
 * render a column. Implement {@link Column#getValue(Object)} to retrieve the
 * field value from the row object that will be rendered in the {@link com.google.gwt.cell.client.Cell}.
 * </p>
 *
 * <p>
...
public abstract class AbstractCellTable<T> extends AbstractHasData<T> {
     ...
     * @see #setColumnWidth(Column, double, com.google.gwt.dom.client.Style.Unit)
     */
     ...
     * Set the width of a {@link Column}. The width will persist with the column
     * and takes precedence of any width set via
     * {@link #setColumnWidth(int, double, com.google.gwt.dom.client.Style.Unit)}.
     *
     * @param column the column
     * @param width the width of the column
     * @param unit the {@link com.google.gwt.dom.client.Style.Unit} of measurement
     */
    public void setColumnWidth(Column<T, ?> column, double width, com.google.gwt.dom.client.Style.Unit unit) {
     ...
     * @param unit the {@link com.google.gwt.dom.client.Style.Unit} of measurement
     */
    public void setColumnWidth(int column, double width, com.google.gwt.dom.client.Style.Unit unit) {
        setColumnWidth(column, width + unit.getType());
    }
     ...
     */
       ...
       * DOM column index.
       */
            Cell.Context context = new Cell.Context(absRow, col, getValueKey(value), subrow);
     ...
     * @see #renderRowValuesLegacy(com.google.gwt.safehtml.shared.SafeHtmlBuilder, List, int, com.google.gwt.view.client.SelectionModel)
     */
    @Override
    @Deprecated
    ...
    protected final void renderRowValuesLegacy(SafeHtmlBuilder sb, List<T> values, int start,
        ...
        for (int i = start; i < end; i++) {
            ...
            for (Column<T, ?> column : columns) {
                ...
                Cell.Context context = new Cell.Context(i, curColumn, getValueKey(value));
    ...
    protected boolean resetFocusOnCell() {
        ...
        Cell.Context context = new Cell.Context(row + getPageStart(), col, key);
    ...
    private <C> void fireEventToCell(Event event, String eventType, Element parentElem,
                                     final T rowValue, Cell.Context context, HasCell<T, C> column) {
    ...
    private <C> boolean resetFocusOnCellImpl(Cell.Context context, T value, HasCell<T, C> column,
                                             Element cellParent) {
