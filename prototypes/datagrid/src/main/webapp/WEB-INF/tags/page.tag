<%@tag description="EBI Page Template" pageEncoding="UTF-8"%>
<!doctype html>
...
<head>
    ...
    <link rel="stylesheet" href="assets/css/annotare-general.css" type="text/css" media="screen">
    <link rel="stylesheet" href="assets/css/annotare-colours.css" type="text/css" media="screen">
    ...
    <!-- Full build -->
    <!-- <script src="//wwwdev.ebi.ac.uk/web_guidelines/js/libs/modernizr.minified.2.1.6.js"></script> -->
...
<div id="wrapper" class="container_24">
    <header>
        ...
        <div id="local-masthead" class="masthead grid_24 nomenu">
            ...
            <div id="local-title">
                <h1><a href="." title="Back to Annotare homepage">Annotare</a></h1>
            </div>
