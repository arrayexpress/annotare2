 ...
 */
class ExtractSerializer10 extends JsonSerializer<Extract> {
    ...
    @Override
    public void serialize(Extract extract, JsonGenerator jgen, SerializerProvider provider) throws IOException {
        generateJson(jgen, extract, EXTRACT_JSON_FIELDS);
    }
}
