...
public class ImportedExperimentProfileSerializer12 extends JsonSerializer<ImportedExperimentProfile> {
    ...
    @Override
    public void serialize(ImportedExperimentProfile importedExperimentProfile,
                          JsonGenerator jgen, SerializerProvider provider) throws IOException {
        generateJson(jgen, importedExperimentProfile, IMPORTED_EXPERIMENT_PROFILE_JSON_FIELDS);
    }
}