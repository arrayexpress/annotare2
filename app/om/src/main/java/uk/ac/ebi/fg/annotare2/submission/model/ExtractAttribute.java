...
public enum ExtractAttribute {
    ...
    LIBRARY_SOURCE("Library Source *",
            ...
            "GENOMIC SINGLE CELL (Genomic content of a single cell, either for WGS or amplicon studies)",
            "TRANSCRIPTOMIC (Transcription products or non genomic DNA (EST, cDNA, RT-PCR, screened libraries))",
            "TRANSCRIPTOMIC SINGLE CELL (RNA-seq of coding RNA from single cells or RNA-seq of non coding RNA from single cells)",
