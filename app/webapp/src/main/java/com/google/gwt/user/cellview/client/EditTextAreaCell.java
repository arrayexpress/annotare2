...
public class EditTextAreaCell extends
    ...
    static class ViewData {
        ...
        public boolean equals(Object o) {
            ...
            EditTextAreaCell.ViewData vd = (EditTextAreaCell.ViewData) o;
    ...
    private static EditTextAreaCell.Template template;
     ...
     *          instance
     */
    public EditTextAreaCell(SafeHtmlRenderer<String> renderer) {
        super(CLICK, KEYUP, KEYDOWN, BLUR);
        if (template == null) {
            template = GWT.create(EditTextAreaCell.Template.class);
        }
        if (renderer == null) {
    ...
    public boolean isEditing(Context context, Element parent, String value) {
        EditTextAreaCell.ViewData viewData = getViewData(context.getKey());
    ...
    public void onBrowserEvent(Context context, Element parent, String value,
        ...
        EditTextAreaCell.ViewData viewData = getViewData(key);
        if (viewData != null && viewData.isEditing()) {
            ...
            if (CLICK.equals(type) || enterPressed) {
                // Go into edit mode.
                if (viewData == null) {
                    viewData = new EditTextAreaCell.ViewData(value);
...
//        input.select();
     ...
     * @param context the context of the cell
     * @param parent the parent Element
     * @param viewData the {@link EditTextAreaCell.ViewData} object
     * @param valueUpdater the {@link ValueUpdater}
     */
    private void commit(Context context, Element parent, EditTextAreaCell.ViewData viewData,
    ...
    private void editEvent(Context context, Element parent, String value,
                           EditTextAreaCell.ViewData viewData, NativeEvent event, ValueUpdater<String> valueUpdater) {
        String type = event.getType();
        ...
        if (keyUp || keyDown) {
            ...
            if (Element.is(eventTarget)) {
                ...
                if ("textarea".equals(target.getTagName().toLowerCase(Locale.ROOT))) {
     ...
     *
     * @param parent the parent element
     * @param viewData the {@link EditTextAreaCell.ViewData} object to update
     * @param isEditing true if in edit mode
     * @return the new value
     */
    private String updateViewData(Element parent, EditTextAreaCell.ViewData viewData,
                                  boolean isEditing) {
