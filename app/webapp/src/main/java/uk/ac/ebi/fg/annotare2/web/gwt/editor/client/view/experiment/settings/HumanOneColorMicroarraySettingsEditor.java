...
public class HumanOneColorMicroarraySettingsEditor extends Composite implements Editor<ExperimentSettings> {
    interface Binder extends UiBinder<Widget, HumanOneColorMicroarraySettingsEditor> {
        HumanOneColorMicroarraySettingsEditor.Binder BINDER = GWT.create(HumanOneColorMicroarraySettingsEditor.Binder.class);
    }
    ...
    public HumanOneColorMicroarraySettingsEditor(ExperimentSettingsPanel panel) {
        this.panel = panel;
        this.arrayDesign = new UpperCaseSuggestBox(new ArrayDesignSuggestOracle(panel));
        initWidget(HumanOneColorMicroarraySettingsEditor.Binder.BINDER.createAndBindUi(this));
    }
    ...
    public ExperimentSettings getValues() {
        ExperimentSettings settings = new ExperimentSettings(ExperimentProfileType.HUMAN_ONE_COLOR_MICROARRAY);
