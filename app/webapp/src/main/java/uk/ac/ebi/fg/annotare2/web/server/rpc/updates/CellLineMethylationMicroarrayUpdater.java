 ...
 */
public class CellLineMethylationMicroarrayUpdater extends BasicExperimentUpdater {

    public CellLineMethylationMicroarrayUpdater(ExperimentProfile exp) {
        super(exp);
    }
    ...
    public void updateSettings(ExperimentSettings settings) {
        if (settings.getExperimentType() != CELL_LINE_METHYLATION_MICROARRAY) {
            return;
        }
