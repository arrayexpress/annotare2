...
public class CellLineOneColorMicroarrayUpdater extends BasicExperimentUpdater{

    private static final String DEFAULT_LABEL = "cy3";

    public CellLineOneColorMicroarrayUpdater(ExperimentProfile exp) {
        super(exp);
    }
    ...
    public void updateSettings(ExperimentSettings settings) {
        if (settings.getExperimentType() != CELL_LINE_ONE_COLOR_MICROARRAY) {
            return;
        }
