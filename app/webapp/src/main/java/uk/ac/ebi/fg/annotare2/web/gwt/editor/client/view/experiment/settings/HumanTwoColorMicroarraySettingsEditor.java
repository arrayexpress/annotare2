 ...
 */
public class HumanTwoColorMicroarraySettingsEditor extends Composite implements Editor<ExperimentSettings> {

    interface Binder extends UiBinder<Widget, HumanTwoColorMicroarraySettingsEditor> {
    ...
    public HumanTwoColorMicroarraySettingsEditor(ExperimentSettingsPanel panel) {
        this.panel = panel;
    ...
    public ExperimentSettings getValues() {
        ExperimentSettings settings = new ExperimentSettings(ExperimentProfileType.HUMAN_TWO_COLOR_MICROARRAY);
