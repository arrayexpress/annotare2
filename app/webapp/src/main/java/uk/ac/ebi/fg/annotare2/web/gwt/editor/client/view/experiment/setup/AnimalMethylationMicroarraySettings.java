...
import static uk.ac.ebi.fg.annotare2.submission.model.ExperimentProfileType.ANIMAL_METHYLATION_MICROARRAY;
import static uk.ac.ebi.fg.annotare2.web.gwt.editor.client.view.utils.ValidationUtils.integerValuesOnly;

/**
 * @author Olga Melnichuk
 */
public class AnimalMethylationMicroarraySettings extends Composite implements HasSubmissionSettings {
    ...
    interface Binder extends UiBinder<Widget, AnimalMethylationMicroarraySettings> {
        Binder BINDER = GWT.create(Binder.class);
    }

    public AnimalMethylationMicroarraySettings(SetupExpSubmissionView view) {
        this.view = view;
    ...
    public ExperimentSetupSettings getSettings() {
        ExperimentSetupSettings settings = new ExperimentSetupSettings(ANIMAL_METHYLATION_MICROARRAY);
