...
import static uk.ac.ebi.fg.annotare2.submission.model.ExperimentProfileType.HUMAN_SEQUENCING;
import static uk.ac.ebi.fg.annotare2.web.gwt.editor.client.view.utils.ValidationUtils.integerValuesOnly;


public class HumanHighThroughputSeqSettings extends Composite implements HasSubmissionSettings {

    @UiField
    TextBox numberOfSamples;

    interface Binder extends UiBinder<Widget, HumanHighThroughputSeqSettings> {
        Binder BINDER = GWT.create(Binder.class);
    }

    public HumanHighThroughputSeqSettings() {
    ...
    public ExperimentSetupSettings getSettings() {
        ExperimentSetupSettings settings = new ExperimentSetupSettings(HUMAN_SEQUENCING);
