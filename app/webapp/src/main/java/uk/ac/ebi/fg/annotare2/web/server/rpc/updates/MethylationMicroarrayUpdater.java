 ...
 */
public class MethylationMicroarrayUpdater extends BasicExperimentUpdater {

    public MethylationMicroarrayUpdater(ExperimentProfile exp) {
        super(exp);
    }
    ...
    public void updateSettings(ExperimentSettings settings) {
        if (settings.getExperimentType() != METHYLATION_MICROARRAY) {
            return;
        }
