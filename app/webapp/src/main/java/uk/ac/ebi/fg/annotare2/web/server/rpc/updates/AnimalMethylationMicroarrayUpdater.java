 ...
 */
public class AnimalMethylationMicroarrayUpdater extends BasicExperimentUpdater {

    public AnimalMethylationMicroarrayUpdater(ExperimentProfile exp) {
        super(exp);
    }
    ...
    public void updateSettings(ExperimentSettings settings) {
        if (settings.getExperimentType() != ANIMAL_METHYLATION_MICROARRAY) {
            return;
        }
