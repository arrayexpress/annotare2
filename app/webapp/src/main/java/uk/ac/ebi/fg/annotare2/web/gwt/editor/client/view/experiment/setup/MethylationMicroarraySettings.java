...
import static uk.ac.ebi.fg.annotare2.submission.model.ExperimentProfileType.METHYLATION_MICROARRAY;
import static uk.ac.ebi.fg.annotare2.web.gwt.editor.client.view.utils.ValidationUtils.integerValuesOnly;

/**
 * @author Olga Melnichuk
 */
public class MethylationMicroarraySettings extends Composite implements HasSubmissionSettings {
    ...
    interface Binder extends UiBinder<Widget, MethylationMicroarraySettings> {
        Binder BINDER = GWT.create(Binder.class);
    }

    public MethylationMicroarraySettings(SetupExpSubmissionView view) {
        this.view = view;
    ...
    public ExperimentSetupSettings getSettings() {
        ExperimentSetupSettings settings = new ExperimentSetupSettings(METHYLATION_MICROARRAY);
