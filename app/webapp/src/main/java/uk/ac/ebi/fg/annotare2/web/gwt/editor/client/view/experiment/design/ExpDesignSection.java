...
public enum ExpDesignSection implements LeftNavigationView.Section {
    ...
    SINGLE_CELL_LIBRARY_INFO("Single-cell library information","Provide technical details of your sequencing libraries as required by the Sequence Read Archive (SRA)",SINGLE_CELL_SEQUENCING, SINGLE_CELL_HUMAN_SEQUENCING, SINGLE_CELL_CELL_LINE_SEQUENCING, SINGLE_CELL_VERTEBRATE_SEQUENCING, SINGLE_CELL_PLANT_SEQUENCING),
