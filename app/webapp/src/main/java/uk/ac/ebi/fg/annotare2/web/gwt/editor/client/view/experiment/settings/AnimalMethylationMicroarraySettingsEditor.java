 ...
 */
public class AnimalMethylationMicroarraySettingsEditor extends Composite implements Editor<ExperimentSettings> {

    interface Binder extends UiBinder<Widget, AnimalMethylationMicroarraySettingsEditor> {
    ...
    public AnimalMethylationMicroarraySettingsEditor(ExperimentSettingsPanel panel) {
        this.panel = panel;
    ...
    public ExperimentSettings getValues() {
        ExperimentSettings settings = new ExperimentSettings(ExperimentProfileType.ANIMAL_METHYLATION_MICROARRAY);
