 ...
 */
public class CellLineTwoColorMicroarraySettingsEditor extends Composite implements Editor<ExperimentSettings> {

    interface Binder extends UiBinder<Widget, CellLineTwoColorMicroarraySettingsEditor> {
    ...
    public CellLineTwoColorMicroarraySettingsEditor(ExperimentSettingsPanel panel) {
        this.panel = panel;
    ...
    public ExperimentSettings getValues() {
        ExperimentSettings settings = new ExperimentSettings(ExperimentProfileType.CELL_LINE_TWO_COLOR_MICROARRAY);
