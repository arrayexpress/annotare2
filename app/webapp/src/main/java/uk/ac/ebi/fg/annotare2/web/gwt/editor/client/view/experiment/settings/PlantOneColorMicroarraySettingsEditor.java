 ...
 */
public class PlantOneColorMicroarraySettingsEditor extends Composite implements Editor<ExperimentSettings> {

    interface Binder extends UiBinder<Widget, PlantOneColorMicroarraySettingsEditor> {
    ...
    public PlantOneColorMicroarraySettingsEditor(ExperimentSettingsPanel panel) {
        this.panel = panel;
