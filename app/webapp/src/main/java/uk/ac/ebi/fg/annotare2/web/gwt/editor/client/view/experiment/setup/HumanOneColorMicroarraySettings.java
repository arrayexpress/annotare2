...
public class HumanOneColorMicroarraySettings extends Composite implements HasSubmissionSettings {
    ...
    interface Binder extends UiBinder<Widget, HumanOneColorMicroarraySettings> {
        Binder BINDER = GWT.create(Binder.class);
    }

    public HumanOneColorMicroarraySettings(SetupExpSubmissionView view) {
        this.view = view;
    ...
    public ExperimentSetupSettings getSettings() {
        ExperimentSetupSettings settings = new ExperimentSetupSettings(HUMAN_ONE_COLOR_MICROARRAY);
