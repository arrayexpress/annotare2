...
import static uk.ac.ebi.fg.annotare2.submission.model.ExperimentProfileType.PLANT_METHYLATION_MICROARRAY;
import static uk.ac.ebi.fg.annotare2.web.gwt.editor.client.view.utils.ValidationUtils.integerValuesOnly;

/**
 * @author Olga Melnichuk
 */
public class PlantMethylationMicroarraySettings extends Composite implements HasSubmissionSettings {
    ...
    interface Binder extends UiBinder<Widget, PlantMethylationMicroarraySettings> {
        Binder BINDER = GWT.create(Binder.class);
    }

    public PlantMethylationMicroarraySettings(SetupExpSubmissionView view) {
        this.view = view;
    ...
    public ExperimentSetupSettings getSettings() {
        ExperimentSetupSettings settings = new ExperimentSetupSettings(PLANT_METHYLATION_MICROARRAY);
