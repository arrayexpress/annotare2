...
import static uk.ac.ebi.fg.annotare2.submission.model.ExperimentProfileType.SINGLE_CELL_PLANT_SEQUENCING;
import static uk.ac.ebi.fg.annotare2.web.gwt.editor.client.view.utils.ValidationUtils.integerValuesOnly;


public class SingleCellPlantHighThroughputSeqSettings extends Composite implements HasSubmissionSettings {

    @UiField
    TextBox numberOfSamples;

    interface Binder extends UiBinder<Widget, SingleCellPlantHighThroughputSeqSettings> {
        Binder BINDER = GWT.create(Binder.class);
    }

    public SingleCellPlantHighThroughputSeqSettings() {
    ...
    public ExperimentSetupSettings getSettings() {
        ExperimentSetupSettings settings = new ExperimentSetupSettings(SINGLE_CELL_PLANT_SEQUENCING);
