...
public class CellLineTwoColorMicroarrayUpdater extends BasicExperimentUpdater {

    public CellLineTwoColorMicroarrayUpdater(ExperimentProfile exp) {
        super(exp);
    }
    ...
    public void updateSettings(ExperimentSettings settings) {
        if (settings.getExperimentType() != CELL_LINE_TWO_COLOR_MICROARRAY) {
            return;
        }
