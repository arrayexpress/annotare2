 ...
 */
public class HumanMethylationMicroarraySettingsEditor extends Composite implements Editor<ExperimentSettings> {

    interface Binder extends UiBinder<Widget, HumanMethylationMicroarraySettingsEditor> {
    ...
    public HumanMethylationMicroarraySettingsEditor(ExperimentSettingsPanel panel) {
        this.panel = panel;
    ...
    public ExperimentSettings getValues() {
        ExperimentSettings settings = new ExperimentSettings(ExperimentProfileType.HUMAN_METHYLATION_MICROARRAY);
