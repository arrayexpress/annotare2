...
public enum ExperimentProfileTypeToAttributesMapping {
    ...
    SINGLE_CELL_EXPERIMENT                      (SINGLE_CELL_SEQUENCING, SINGLE_CELL_WELL_QUALITY_ATTRIBUTE, POST_ANALYSIS_WELL_QUALITY_ATTRIBUTE, INFERRED_CELL_TYPE_ATTRIBUTE, SINGLE_CELL_IDENTIFIER_ATTRIBUTE,CELL_TYPE_ORIGIN); //Template has been changed for this type to include these attribute as optional not mandatory
