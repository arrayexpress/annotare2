...
public enum ExperimentProfileTypeToAttributesMapping {
    ...
    SINGLE_CELL_EXPERIMENT                  (SEQUENCING, SINGLE_CELL_WELL_QUALITY_ATTRIBUTE, POST_ANALYSIS_WELL_QUALITY_ATTRIBUTE, INFERRED_CELL_TYPE, SINGLE_CELL_IDENTIFIER); //Template has been changed for this type to include these attribute as optional not mandatory
