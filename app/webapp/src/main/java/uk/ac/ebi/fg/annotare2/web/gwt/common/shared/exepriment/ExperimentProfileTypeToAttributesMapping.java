...
public enum ExperimentProfileTypeToAttributesMapping {
    ...
    ANIMAL_SINGLE_CELL_EXPERIMENT           (SINGLE_CELL_ANIMAL_SEQUENCING,ORGANISM_ATTRIBUTE,STRAIN_ATTRIBUTE,AGE_ATTRIBUTE,DEVELOPMENTAL_STAGE_ORIGIN,SEX_ORIGIN,GENOTYPE_ATTRIBUTE,ORGANISM_PART_ATTRIBUTE,INDIVIDUAL_ORIGIN),
