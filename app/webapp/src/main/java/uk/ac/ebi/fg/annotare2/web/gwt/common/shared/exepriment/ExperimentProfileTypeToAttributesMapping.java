...
public enum ExperimentProfileTypeToAttributesMapping {
    ...
    HUMAN_METHYLATION_MICROARRAY_EXPERIMENT     (HUMAN_METHYLATION_MICROARRAY, ORGANISM_ATTRIBUTE,CULTIVAR_ATTRIBUTE,AGE_ATTRIBUTE,DEVELOPMENTAL_STAGE_ORIGIN,GENOTYPE_ATTRIBUTE,ORGANISM_PART_ATTRIBUTE),
    ...
    HUMAN_SINGLE_CELL_EXPERIMENT                (SINGLE_CELL_HUMAN_SEQUENCING,ORGANISM_ATTRIBUTE,AGE_ATTRIBUTE,DEVELOPMENTAL_STAGE_ORIGIN,SEX_ORIGIN,DESEASE_ATTRIBUTE,ORGANISM_PART_ATTRIBUTE,INDIVIDUAL_ORIGIN),
    ...
    ANIMAL_METHYLATION_MICROARRAY_EXPERIMENT    (ANIMAL_METHYLATION_MICROARRAY, ORGANISM_ATTRIBUTE,CULTIVAR_ATTRIBUTE,AGE_ATTRIBUTE,DEVELOPMENTAL_STAGE_ORIGIN,GENOTYPE_ATTRIBUTE,ORGANISM_PART_ATTRIBUTE),
    ...
    CELL_LINE_METHYLATION_MICROARRAY_EXPERIMENT (CELL_LINE_METHYLATION_MICROARRAY, ORGANISM_ATTRIBUTE,CULTIVAR_ATTRIBUTE,AGE_ATTRIBUTE,DEVELOPMENTAL_STAGE_ORIGIN,GENOTYPE_ATTRIBUTE,ORGANISM_PART_ATTRIBUTE),
    ...
    SINGLE_CELL_EXPERIMENT                      (SINGLE_CELL_SEQUENCING, SINGLE_CELL_WELL_QUALITY_ATTRIBUTE, POST_ANALYSIS_WELL_QUALITY_ATTRIBUTE, INFERRED_CELL_TYPE, SINGLE_CELL_IDENTIFIER); //Template has been changed for this type to include these attribute as optional not mandatory
