 ...
 */
public class PlantOneColorMicroarraySettings extends Composite implements HasSubmissionSettings {
    ...
    interface Binder extends UiBinder<Widget, PlantOneColorMicroarraySettings> {
        PlantOneColorMicroarraySettings.Binder BINDER = GWT.create(PlantOneColorMicroarraySettings.Binder.class);
    }

    public PlantOneColorMicroarraySettings(SetupExpSubmissionView view) {
        this.view = view;
        this.arrayDesign = new UpperCaseSuggestBox(new ArrayDesignSuggestOracle(view));
        initWidget(PlantOneColorMicroarraySettings.Binder.BINDER.createAndBindUi(this));
