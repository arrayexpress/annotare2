...
import static uk.ac.ebi.fg.annotare2.submission.model.ExperimentProfileType.SINGLE_CELL_CELL_LINE_SEQUENCING;
import static uk.ac.ebi.fg.annotare2.web.gwt.editor.client.view.utils.ValidationUtils.integerValuesOnly;


public class SCCellLineHighThroughputSeqSettings extends Composite implements HasSubmissionSettings {

    @UiField
    TextBox numberOfSamples;

    interface Binder extends UiBinder<Widget, SCCellLineHighThroughputSeqSettings> {
        Binder BINDER = GWT.create(Binder.class);
    }

    public SCCellLineHighThroughputSeqSettings() {
    ...
    public ExperimentSetupSettings getSettings() {
        ExperimentSetupSettings settings = new ExperimentSetupSettings(SINGLE_CELL_CELL_LINE_SEQUENCING);
