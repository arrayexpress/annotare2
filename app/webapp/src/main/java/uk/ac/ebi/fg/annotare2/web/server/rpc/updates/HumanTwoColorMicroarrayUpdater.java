...
public class HumanTwoColorMicroarrayUpdater extends BasicExperimentUpdater {

    public HumanTwoColorMicroarrayUpdater(ExperimentProfile exp) {
        super(exp);
    }
    ...
    public void updateSettings(ExperimentSettings settings) {
        if (settings.getExperimentType() != HUMAN_TWO_COLOR_MICROARRAY) {
            return;
        }
