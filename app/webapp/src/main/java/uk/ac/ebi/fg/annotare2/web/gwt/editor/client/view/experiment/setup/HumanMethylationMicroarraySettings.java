 ...
 */
public class HumanMethylationMicroarraySettings extends Composite implements HasSubmissionSettings {
    ...
    interface Binder extends UiBinder<Widget, HumanMethylationMicroarraySettings> {
        Binder BINDER = GWT.create(Binder.class);
    }

    public HumanMethylationMicroarraySettings(SetupExpSubmissionView view) {
        this.view = view;
    ...
    public ExperimentSetupSettings getSettings() {
        ExperimentSetupSettings settings = new ExperimentSetupSettings(HUMAN_METHYLATION_MICROARRAY);
