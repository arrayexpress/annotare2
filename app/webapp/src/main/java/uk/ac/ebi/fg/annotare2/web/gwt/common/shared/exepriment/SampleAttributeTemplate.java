...
public enum SampleAttributeTemplate {
    ...
    SINGLE_CELL_IDENTIFIER_ATTRIBUTE(SINGLE_CELL_IDENTIFIER, of(FACTOR_VALUE)),
    INFERRED_CELL_TYPE_ATTRIBUTE(INFERRED_CELL_TYPE, range(CHARACTERISTIC, CHARACTERISTIC_AND_FACTOR_VALUE)),
