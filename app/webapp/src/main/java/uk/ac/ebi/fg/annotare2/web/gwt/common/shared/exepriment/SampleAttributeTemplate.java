...
public enum SampleAttributeTemplate {
    ...
    SINGLE_CELL_IDENTIFIER(SystemEfoTerm.SINGLE_CELL_IDENTIFIER, of(FACTOR_VALUE)), //We are having same name here to mantain backward compatibility. Its not good but have to live with it :(((
    INFERRED_CELL_TYPE(SystemEfoTerm.INFERRED_CELL_TYPE, range(CHARACTERISTIC, CHARACTERISTIC_AND_FACTOR_VALUE)),
    RESPONSE_TO_TREATMENT_ATTRIBUTE("Response to Treatment",range(CHARACTERISTIC, CHARACTERISTIC_AND_FACTOR_VALUE)),
    SINGLE_CELL_WELL_QUALITY_ATTRIBUTE("Single Cell Well Quality", range(CHARACTERISTIC, CHARACTERISTIC_AND_FACTOR_VALUE)),
    POST_ANALYSIS_WELL_QUALITY_ATTRIBUTE("Post Analysis Well Quality", range(CHARACTERISTIC, CHARACTERISTIC_AND_FACTOR_VALUE)),
    XENOGRAFT_ATTRIBUTE("Xenograft",range(CHARACTERISTIC, CHARACTERISTIC_AND_FACTOR_VALUE)),
