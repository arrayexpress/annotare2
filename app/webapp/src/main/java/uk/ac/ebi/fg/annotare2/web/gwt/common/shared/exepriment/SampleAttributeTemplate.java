...
public enum SampleAttributeTemplate {
    ...
    SINGLE_CELL_IDENTIFIER("Single Cell Identifier", of(FACTOR_VALUE)),
    INFERRED_CELL_TYPE("Inferred Cell Type", range(CHARACTERISTIC, CHARACTERISTIC_AND_FACTOR_VALUE)),
