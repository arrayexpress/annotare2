...
import static uk.ac.ebi.fg.annotare2.submission.model.ExperimentProfileType.HUMAN_TWO_COLOR_MICROARRAY;
import static uk.ac.ebi.fg.annotare2.web.gwt.editor.client.view.utils.ValidationUtils.integerValuesOnly;

public class HumanTwoColorMicroarraySettings extends Composite implements HasSubmissionSettings {
    ...
    interface Binder extends UiBinder<Widget, HumanTwoColorMicroarraySettings> {
        Binder BINDER = GWT.create(Binder.class);
    }

    public HumanTwoColorMicroarraySettings(SetupExpSubmissionView view) {
        this.view = view;
    ...
    public ExperimentSetupSettings getSettings() {
        ExperimentSetupSettings settings = new ExperimentSetupSettings(HUMAN_TWO_COLOR_MICROARRAY);
