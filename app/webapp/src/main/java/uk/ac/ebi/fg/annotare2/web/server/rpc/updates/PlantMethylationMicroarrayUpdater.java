 ...
 */
public class PlantMethylationMicroarrayUpdater extends BasicExperimentUpdater {

    public PlantMethylationMicroarrayUpdater(ExperimentProfile exp) {
        super(exp);
    }
    ...
    public void updateSettings(ExperimentSettings settings) {
        if (settings.getExperimentType() != PLANT_METHYLATION_MICROARRAY) {
            return;
        }
