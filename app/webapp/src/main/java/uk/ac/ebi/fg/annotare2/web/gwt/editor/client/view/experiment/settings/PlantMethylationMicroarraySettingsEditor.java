 ...
 */
public class PlantMethylationMicroarraySettingsEditor extends Composite implements Editor<ExperimentSettings> {

    interface Binder extends UiBinder<Widget, PlantMethylationMicroarraySettingsEditor> {
    ...
    public PlantMethylationMicroarraySettingsEditor(ExperimentSettingsPanel panel) {
        this.panel = panel;
    ...
    public ExperimentSettings getValues() {
        ExperimentSettings settings = new ExperimentSettings(ExperimentProfileType.PLANT_METHYLATION_MICROARRAY);
