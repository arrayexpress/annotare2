 ...
 */
public class CellLineMethylationMicroarraySettingsEditor extends Composite implements Editor<ExperimentSettings> {

    interface Binder extends UiBinder<Widget, CellLineMethylationMicroarraySettingsEditor> {
    ...
    public CellLineMethylationMicroarraySettingsEditor(ExperimentSettingsPanel panel) {
        this.panel = panel;
    ...
    public ExperimentSettings getValues() {
        ExperimentSettings settings = new ExperimentSettings(ExperimentProfileType.CELL_LINE_METHYLATION_MICROARRAY);
