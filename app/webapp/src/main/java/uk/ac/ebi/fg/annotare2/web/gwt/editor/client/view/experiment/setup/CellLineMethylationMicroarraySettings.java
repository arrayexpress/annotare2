...
import static uk.ac.ebi.fg.annotare2.submission.model.ExperimentProfileType.CELL_LINE_METHYLATION_MICROARRAY;
import static uk.ac.ebi.fg.annotare2.web.gwt.editor.client.view.utils.ValidationUtils.integerValuesOnly;

/**
 * @author Olga Melnichuk
 */
public class CellLineMethylationMicroarraySettings extends Composite implements HasSubmissionSettings {
    ...
    interface Binder extends UiBinder<Widget, CellLineMethylationMicroarraySettings> {
        Binder BINDER = GWT.create(Binder.class);
    }

    public CellLineMethylationMicroarraySettings(SetupExpSubmissionView view) {
        this.view = view;
    ...
    public ExperimentSetupSettings getSettings() {
        ExperimentSetupSettings settings = new ExperimentSetupSettings(CELL_LINE_METHYLATION_MICROARRAY);
