 ...
 */
public class AnimalTwoColorMicroarraySettingsEditor extends Composite implements Editor<ExperimentSettings> {

    interface Binder extends UiBinder<Widget, AnimalTwoColorMicroarraySettingsEditor> {
    ...
    public AnimalTwoColorMicroarraySettingsEditor(ExperimentSettingsPanel panel) {
        this.panel = panel;
    ...
    public ExperimentSettings getValues() {
        ExperimentSettings settings = new ExperimentSettings(ExperimentProfileType.ANIMAL_TWO_COLOR_MICROARRAY);
