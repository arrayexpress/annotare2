...
import static uk.ac.ebi.fg.annotare2.submission.model.ExperimentProfileType.CELL_LINE_ONE_COLOR_MICROARRAY;
import static uk.ac.ebi.fg.annotare2.web.gwt.editor.client.view.utils.ValidationUtils.integerValuesOnly;

public class CellLineOneColorMicroarraySettings extends Composite implements HasSubmissionSettings {
    ...
    interface Binder extends UiBinder<Widget, CellLineOneColorMicroarraySettings> {
        Binder BINDER = GWT.create(Binder.class);
    }

    public CellLineOneColorMicroarraySettings(SetupExpSubmissionView view) {
        this.view = view;
    ...
    public ExperimentSetupSettings getSettings() {
        ExperimentSetupSettings settings = new ExperimentSetupSettings(CELL_LINE_ONE_COLOR_MICROARRAY);
