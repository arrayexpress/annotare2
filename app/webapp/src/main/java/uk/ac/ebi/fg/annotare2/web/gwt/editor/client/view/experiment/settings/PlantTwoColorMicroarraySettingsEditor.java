 ...
 */
public class PlantTwoColorMicroarraySettingsEditor extends Composite implements Editor<ExperimentSettings> {

    interface Binder extends UiBinder<Widget, PlantTwoColorMicroarraySettingsEditor> {
    ...
    public PlantTwoColorMicroarraySettingsEditor(ExperimentSettingsPanel panel) {
        this.panel = panel;
    ...
    public ExperimentSettings getValues() {
        ExperimentSettings settings = new ExperimentSettings(new PlantTwoColorMicroarrayExpProfileType("Plant - Two-color microarray"));
