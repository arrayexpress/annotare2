...
public class ProtocolTypes {
    ...
    private enum Usage {
        MICRO_ARRAY(of(ONE_COLOR_MICROARRAY,
                TWO_COLOR_MICROARRAY,
                METHYLATION_MICROARRAY,
                HUMAN_ONE_COLOR_MICROARRAY,
                HUMAN_TWO_COLOR_MICROARRAY,
                HUMAN_METHYLATION_MICROARRAY,
                CELL_LINE_ONE_COLOR_MICROARRAY,
                CELL_LINE_TWO_COLOR_MICROARRAY,
                CELL_LINE_METHYLATION_MICROARRAY,
                ANIMAL_ONE_COLOR_MICROARRAY,
                ANIMAL_TWO_COLOR_MICROARRAY,
                ANIMAL_METHYLATION_MICROARRAY)),
        SEQUENCING(of(ExperimentProfileType.SEQUENCING,
                HUMAN_SEQUENCING,
                CELL_LINE_SEQUENCING,
                ANIMAL_SEQUENCING,
                SINGLE_CELL_SEQUENCING,
                SINGLE_CELL_HUMAN_SEQUENCING,
                SINGLE_CELL_CELL_LINE_SEQUENCING,
                SINGLE_CELL_ANIMAL_SEQUENCING,
                SINGLE_CELL_PLANT_SEQUENCING)),
        PLANT_SEQUENCING(of(ExperimentProfileType.PLANT_SEQUENCING)),
        PLANT_MICRO_ARRAY(of(PLANT_ONE_COLOR_MICROARRAY,
                PLANT_TWO_COLOR_MICROARRAY,
                PLANT_METHYLATION_MICROARRAY)),
