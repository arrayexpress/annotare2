...
public class ProtocolTypes {
    ...
    private enum Usage {
        MICRO_ARRAY(of(ONE_COLOR_MICROARRAY, TWO_COLOR_MICROARRAY, HUMAN_ONE_COLOR_MICROARRAY, HUMAN_TWO_COLOR_MICROARRAY, CELL_LINE_ONE_COLOR_MICROARRAY, CELL_LINE_TWO_COLOR_MICROARRAY, VERTEBRATE_ONE_COLOR_MICROARRAY, VERTEBRATE_TWO_COLOR_MICROARRAY)),
        SEQUENCING(of(ExperimentProfileType.SEQUENCING, HUMAN_SEQUENCING, CELL_LINE_SEQUENCING, VERTEBRATE_SEQUENCING, SINGLE_CELL_SEQUENCING, SINGLE_CELL_HUMAN_SEQUENCING, SINGLE_CELL_CELL_LINE_SEQUENCING, SINGLE_CELL_VERTEBRATE_SEQUENCING, SINGLE_CELL_PLANT_SEQUENCING)),
