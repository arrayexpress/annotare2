...
public class MageTabUtils {
    ...
    static {
        errorMap.put("ADMN01", "[<a href=\"#DESIGN:FILES\">Assign Files</a>] The 'Raw Data Matrix File' column has not been filled in (completely). See <a href=\"../help/assign_files.html\">Assign files to samples (Annotare Help)</a> for more details.");
        ...
        errorMap.put("ADN01", "[<a href=\"#DESIGN:FILES\">Assign Files</a>] The 'Raw Data File' column has not been filled in (completely). See <a href=\"../help/assign_files.html\">Assign files to samples (Annotare Help)</a> for more details.");
        errorMap.put("ADN02", "[<a href=\"#DESIGN:FILES\">Assign Files</a>] A raw data file name can only contain alphanumeric characters, underscores and dots. Click on the file name in the upload panel to rename, then press 'Enter' to save the changes.");
        errorMap.put("AN01", "[<a href=\"#DESIGN:FILES\">Assign Files</a>] An assay name could not be generated automatically. You may not have assigned a data file to the sample(s). See <a href=\"../help/assign_files.html\">Assign files to samples (Annotare Help)</a> for more details.");
        ...
        errorMap.put("AN08", "[<a href=\"#DESIGN:FILES\">Assign Files</a>] The assignment between files and samples contains errors. You may have chosen the wrong type of data column (e.g. choose 'Raw Matrix', not 'Raw', if you have 1 file containing raw data for multiple samples). For two-color experiments, there may be a problem with the relationship between files and samples (expects 1 raw data file per 2 labeled extracts). See <a href=\"../help/assign_files.html\">Assign files to samples (Annotare Help)</a> and <a href=\"../help/two_color_ma.html\">Two-color experiments (Annotare Help)</a> for more details.");
        errorMap.put("C01", "[<a href=\"#INFO:CONTACTS\">Contacts</a>] At least one contact must be included. Go to [<a href=\"#INFO:CONTACTS\">Contacts</a>] and press the '+' sign to create a new contact.");
        errorMap.put("C02", "[<a href=\"#INFO:CONTACTS\">Contacts</a>] A contact must have a last name specified. Go to [<a href=\"#INFO:CONTACTS\">Contacts</a>], select a contact, and fill in the form.");
        errorMap.put("C03", "[<a href=\"#INFO:CONTACTS\">Contacts</a>] At least one contact must have an email address specified. Go to [<a href=\"#INFO:CONTACTS\">Contacts</a>], select a contact, and fill in the form.");
        errorMap.put("C04", "[<a href=\"#INFO:CONTACTS\">Contacts</a>] At least one contact must have a role specified. In the [<a href=\"#INFO:CONTACTS\">Contacts</a>] form, click on 'change' next to 'Roles' to select the role(s) of the contact.");
        errorMap.put("C05", "[<a href=\"#INFO:CONTACTS\">Contacts</a>] At least one contact must have the role 'submitter'. In the [<a href=\"#INFO:CONTACTS\">Contacts</a>] form, click on 'change' next to 'Roles' to select the role(s) of the contact.");
        errorMap.put("C06", "[<a href=\"#INFO:CONTACTS\">Contacts</a>] A contact with 'submitter' role must have an affiliation specified. Go to [<a href=\"#INFO:CONTACTS\">Contacts</a>], select the contact with role 'submiter', and fill in the form.");
        errorMap.put("C07", "[<a href=\"#INFO:CONTACTS\">Contacts</a>] A contact with 'submitter' role must have an email address specified. Go to [<a href=\"#INFO:CONTACTS\">Contacts</a>], select the contact with role 'submitter', and fill in the form.");
        ...
        errorMap.put("DADN01", "[<a href=\"#DESIGN:FILES\">Assign Files</a>] The 'Processed Data File' column has not been filled in (completely). See <a href=\"../help/assign_files.html\">Assign files to samples (Annotare Help)</a> for more details.");
        ...
        errorMap.put("FV04", "[<a href=\"#DESIGN:SAMPLES\">Sample annotation</a>] The values of an experimental variable must vary (for compound+dose at least one must vary). An experimental variable contains the same values for all samples. Make sure the correct values were entered, or if the repeated value is not a factor in this experiment, uncheck 'Experimental Variable' (in the 'Add Samples and Experimental Variables' dialogue).");
        ...
        errorMap.put("LC01", "[<a href=\"#DESIGN:EXTRACTS_LIBRARY_INFO\">Library Info</a>] The library source, layout, selection and strategy must be specified in the ENA library info. See <a href=\"../help/seq_lib_spec.html\">Sequencing library information (Annotare Help)</a> for more details.");
        errorMap.put("LC02", "[<a href=\"#DESIGN:EXTRACTS_LIBRARY_INFO\">Library Info</a>] NOMINAL_LENGTH and NOMINAL_SDEV must be provided for paired-end sequencing samples in [<a href=\"#DESIGN:EXTRACTS_LIBRARY_INFO\">Library Info</a>]. Both must be a positive integer. See <a href=\"../help/seq_lib_spec.html\">Sequencing library information (Annotare Help)</a> for more details.");
        ...
        errorMap.put("PB02", "[<a href=\"#INFO:PUBLICATIONS\">Publication</a>] The PubMed ID field can only contain numbers, and no other characters (including whitespaces).");
