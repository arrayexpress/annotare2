...
public class MageTabUtils {
    ...
    static {
        ...
        errorMap.put("FV04", "[<a href=\"#DESIGN:SAMPLES\">Sample annotation</a>] The values of an experimental variable must vary (for compound+dose at least one must vary). One of the experimental variables contains the same values for all samples. Make sure the correct values were entered, or if the attribute is not a factor in this experiment, uncheck 'Experimental Variable' in the 'Add Samples and Experimental Variables' dialogue.( %s )");
