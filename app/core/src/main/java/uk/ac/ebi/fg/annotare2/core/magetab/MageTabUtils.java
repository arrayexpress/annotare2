...
public class MageTabUtils {
    ...
    static {
        ...
        errorMap.put("C06", "[<a href=\"#DESIGN:CONTACTS\">Contacts</a>] A contact with 'submitter' role must have an affiliation specified. Go to [<a href=\"#DESIGN:CONTACTS\">Contacts</a>], select the contact with role 'submiter', and fill in the form.");
