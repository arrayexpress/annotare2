...
public class AdfServiceImpl extends SubmissionBasedRemoteService implements AdfService {
    ...
    @Override
    public void importHeaderData(int submissionId) throws NoPermissionException, ResourceNotFoundException, DataImportException {
        try {
            ...
            Table table = new AdfParser().parseHeader(item.getInputStream());
            ...
            log.warn("Can't import ADF header data (submissionId: " + submissionId + ")", e);
