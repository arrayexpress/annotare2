 ...
 */
public class EditorDockBarPanelActivityMapper implements ActivityMapper {

    private final Provider<DataFileUploadActivity> provider;
    private DataFileUploadActivity current;

    @Inject
    public EditorDockBarPanelActivityMapper(Provider<DataFileUploadActivity> provider) {
