 ...
 */
public class UpdateProtocolAssignmentsCommand implements ExperimentUpdateCommand {
    ...
    public UpdateProtocolAssignmentsCommand(ProtocolAssignmentProfileUpdates updates) {
        this.updates = updates;
    }

    @Override
    public void execute(ExperimentUpdatePerformer performer) {
        performer.updateProtocolAssignments(updates);
    }
